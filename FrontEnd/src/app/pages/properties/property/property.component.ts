...
export class PropertyComponent implements OnInit {
    ...
    public getPropertyById(id) {
        this.appService.getPropertyById(id).subscribe(data => {
            this.property = data['data']['properties'];
            this.property.propertyStatus = JSON.parse(this.property.propertyStatus);
            this.property.neighborhood = JSON.parse(this.property.neighborhood);
            this.property.street = JSON.parse(this.property.street);
            this.property.location = JSON.parse(this.property.location);
            this.property.features = JSON.parse(this.property.features);
            this.property.priceDollar = JSON.parse(this.property.priceDollar);
            this.property.priceEuro = JSON.parse(this.property.priceEuro);
            this.property.area = JSON.parse(this.property.area);
            this.property.additionalFeatures = JSON.parse(this.property.additionalFeatures);
            this.property.gallery = JSON.parse(this.property.gallery);
            this.property.plans = JSON.parse(this.property.plans);
            this.property.videos = JSON.parse(this.property.videos);
        ...
        // this.MyHttp.get<any>(url).subscribe(res => {
    ...
    // public UpdateCard(Image){
    //   return this.http.post(this.url, inputdata, options)
